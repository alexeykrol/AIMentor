              ...
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 max-w-4xl w-full mb-3 sm:mb-6">
                  {PRESET_QUESTIONS.map((question, index) => (
                    <button
                      ...
                      className="flex items-center justify-center p-2 sm:p-3 lg:p-4 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-lg transition-colors text-xs text-gray-700 hover:text-gray-900 min-h-[40px] sm:min-h-[50px] lg:min-h-[60px]"
                    >
                ...
                <div className="max-w-4xl w-full grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                  <button
                    ...
                    className="p-2 sm:p-3 lg:p-4 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-lg transition-colors text-xs text-blue-700 hover:text-blue-800 font-medium"
                  >
                  ...
                  <button
                    ...
                    className="p-2 sm:p-3 lg:p-4 bg-green-50 hover:bg-green-100 border border-green-200 rounded-lg transition-colors text-xs text-green-700 hover:text-green-800 font-medium"
                  >
                    🎯 Мои вопросы
                  </button>
                </div>
              ...
              <>
                ...
                <div className="max-w-4xl w-full grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                  ...
                  <button
                    ...
                    className={`p-2 sm:p-3 lg:p-4 rounded-lg transition-colors text-xs font-medium ${
                      personalQuestionMode 
      ...
      <div className="p-2 sm:p-4 border-t border-gray-200 bg-gray-50 rounded-b-lg flex-shrink-0 w-full">
        ...
        {showError && (
          <div className="mb-2 sm:mb-3 p-2 sm:p-3 bg-red-50 border border-red-200 rounded-lg flex items-start space-x-2">
            ...
            <p className="text-xs text-red-700">{APP_TEXTS.ERROR_TEXT_TOO_LONG}</p>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="flex space-x-2 w-full">
          <div className="flex-1 relative">
            ...
            <textarea
              ...
              className={`w-full px-2 sm:px-3 lg:px-4 py-2 sm:py-3 text-xs border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors resize-none ${
