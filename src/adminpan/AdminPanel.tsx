...
const MENU_ITEMS = [
  { id: 'config' as MenuItemType, title: 'Конфигурация', icon: Settings },
  ...
  { id: 'roles' as MenuItemType, title: 'Роли и права', icon: Shield },
  { id: 'activity' as MenuItemType, title: 'Активность', icon: BarChart3 },
  { id: 'database' as MenuItemType, title: 'База данных', icon: Database },
  { id: 'logs' as MenuItemType, title: 'Логи системы', icon: BarChart3 },
];
